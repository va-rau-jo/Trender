    ...
    return (
      <div className={classes.header}>      
        ...
        <div className={classes.headerRight}>
          <div className={classes.description}>
            <Typography className={classes.titleRight} variant="h4"> {playlist2.name} </Typography>
            <Typography className={classes.songCount} variant="subtitle2"> {playlist2.tracks.total} songs </Typography>
          </div>
